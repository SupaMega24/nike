...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <p className="text-xl font-montserra text-coral-red">
          Just Do It Summer Collection
        </p>
        <h1 className="mt-10 font-palanquin text-8xl 
          max-sm:text-[52px] max-sm:leading-[62px] font-bold"
        >
          <span className="lg:bg-white 
            lg:whitespace-nowrap relative z-10 pr-10"
          >
            Just Arrived
          </span>
          <br />
        ...
        >
          Check out these stylish kicks 
          providing quality comfort 
          and innovation for your active lifestyle
        </p>
        <Button 
          label='Just Click It'
          iconURL={arrowRight}
